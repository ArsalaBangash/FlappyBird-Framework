...
## This variable controls speed of the game - you can  change its value to make the game go faster or slower {variable = game_speed}

'''This is a String Varible'''
## This variable controls the background of the game - you can  change its value choose between the night and day background { variable = game_background}

'''This is a String Varible'''
## This variable controls the color of the bird - you can  change its value choose between the different color of the bird {variable = game_color}
